    ...
    return (
        <div className="flex-1 bg-black flex flex-col items-center justify-center p-8">
            <main className="flex flex-col items-center gap-8 max-w-md w-full">
                ...
                <div className="text-white text-center text-xl">start sharing & discovering music on echo.</div>
...
function RegistrationForm2({ phoneNumber, phoneNumberChecked, inviter }: RegistrationFormProps) {
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-6">
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    >
                        <div className="block">
                            I agree to receive SMS from Echo about song suggestions and app updates. Message frequency may vary. Message & data rates may apply. Reply STOP to opt out, HELP for help. Consent is not required to use the service.
                        </div>
                        <div className="block mt-2">
                            Privacy Policy: <Link href="/privacy-policy" className="underline hover:text-gray-300">Privacy Policy</Link> Support: <Link href="mailto:support@text-echo.com" className="underline hover:text-gray-300">support@text-echo.com</Link>
                        </div>
                    </Label>
                </div>
                <div className="flex items-center space-x-2">
                    <Checkbox 
                        ...
                        onCheckedChange={() => setTermsChecked(termsChecked === true ? false : true)}
                    />
                    <Label 
                ...
                type="submit" 
                disabled={!formData.firstName.trim() || !formData.lastName.trim() || !formData.phoneNumber.trim() || !phoneNumberChecked || !consentChecked || !termsChecked} 
                >
