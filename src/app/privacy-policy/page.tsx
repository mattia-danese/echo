      ...
      <div className="max-w-4xl mx-auto px-6 py-12 text-white">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <p className="mb-4">
              Echo Music Discovery, Inc. ("Echo," "we," "our," or "us") values
              your privacy. This Privacy Policy explains how we collect, use,
              share, and protect your personal information when you use the Echo
              Services.
            </p>
            <p className="mb-4">
              By using the Echo Services, you consent to the practices described
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              ...
              <p className="mb-4">
                Data from Spotify and Apple Music that you authorize us to
                access, such as your listening history, playlists, and favorite
                songs.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="mb-4">
                ...
                information, and site usage activity.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              <li className="mb-2">
                Provide, maintain, and improve the Echo Services.
              </li>
              <li className="mb-2">
                Deliver song recommendations from your friends.
              </li>
              <li className="mb-2">Personalize your experience.</li>
              <li className="mb-2">
                Communicate with you about your account or updates to the Echo
                Services.
              </li>
              <li className="mb-2">
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              <h3 className="text-xl font-semibold mb-3">
                With Friends on Echo:
              </h3>
              <p className="mb-4">
                Recommendations you make will be visible to your Echo friends.
                They are not shared outside your Echo network.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="mb-4">
                When you connect Spotify or Apple Music, you authorize us to
                share information as necessary to enable Echo functionality.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="mb-4">
                We may share information with vendors that support our
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              ...
              <p className="mb-4">
                ...
                via your Echo profile settings.
              </p>
            </div>

            <div className="mb-6">
              <h3 className="text-xl font-semibold mb-3">
                Spotify/Apple Music Permissions:
              </h3>
              <p className="mb-4">
                You can manage or revoke Echo's access through your Spotify and
            ...
            <div className="mb-6">
              ...
              <p className="mb-4">
                You may close your Echo Account at any time. Upon closure, we
            ...
            <div className="mb-6">
              ...
              <p className="mb-4">
                You may opt out of text messages by replying "STOP" to the echo
                phone number.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              administrative measures to protect your information. However, no
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Echo is not directed to children under 13. If we learn that we
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Echo is based in the United States. If you access the Echo
              Services from outside the U.S., you consent to the transfer of
              your data to the U.S. and the processing of your data in
